...
salonRouter.patch("/employees/:id", requireFeature("EMPLOYEES"), updateEmployee);
salonRouter.delete("/employees/:id", requireFeature("EMPLOYEES"), deleteEmployee);
salonRouter.post("/inventory", requireFeature("INVENTORY"), createInventory);
salonRouter.patch("/inventory/:id", requireFeature("INVENTORY"), updateInventory);
salonRouter.delete("/inventory/:id", requireFeature("INVENTORY"), deleteInventory);
...
salonRouter.post("/appointments", requireFeature("APPOINTMENTS"), createAppointment);
salonRouter.put("/appointments/:id", requireFeature("APPOINTMENTS"), updateAppointment);
salonRouter.delete("/appointments/:id", requireFeature("APPOINTMENTS"), deleteAppointment);
salonRouter.post("/invoices", requireFeature("INVOICES"), createInvoiceController);
...
salonRouter.use("/leave-requests", requireFeature("EMPLOYEES"), leaveRequestRouter);
...
salonRouter.use("/purchase-orders", requireFeature("INVENTORY"), purchaseOrderRouter);
